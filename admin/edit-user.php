...
if(isset($_POST['name']) && isset($_POST['status']) && isset($_POST['point'])  ){

	if($_POST['Password'] != null){

		$status = $Database->update_user($_POST['id'],$_POST['name'],$_POST['Password'],$_POST['nick'],$_POST['status'],$_POST['point']);

		if($status){

			header("Location: /admin/manage-member?status=done");
		...
		$status = $Database->update_user($_POST['id'],$_POST['name'],false,$_POST['nick'],$_POST['status'],$_POST['point']);
						...
						<form method="post" action="" class="form-horizontal">
							...
							<div class="card-content">
								...
								<div class="row">
									...
									<label class="col-sm-2 label-on-left">Team</label>
									...
									<div class="col-sm-10">
										...
										<div class="form-group label-floating is-empty">
											...
											<input name="nick" type="text" class="form-control" placeholder="Nama Universitas" required="" value="<?= $edit['nick']?>">
