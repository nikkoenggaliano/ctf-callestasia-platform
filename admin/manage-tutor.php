				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="card-content">
							<h4 class="card-title">Manage Tutor</h4>
							<div class="row">
								<div class="col-md-12">
								<a href="tambahtutor" class="btn btn-rose" role="button">Tambah Tutor</a>
									<div class="table-responsive table-sales">
										<table class="table">
											<tbody>
												...
												<?php
													$datarray = $Database->tampilkan_tutor_list();
													foreach ($datarray as $key => $data) {?>
														<tr>
															...
															<td class="text-right"><?= $data['author']; ?></td>
															<td class="td-actions text-right">
																<a href="edit/<?= $data['id']; ?>/tutor" class="btn btn-info" role="button"><i class="material-icons">edit</i></a>
																<a href="delete/<?= $data['id']; ?>/tutor" class="btn btn-danger" role="button"><i class="material-icons">close</i></a>
															</td>
														</tr>
													<?php
													}
