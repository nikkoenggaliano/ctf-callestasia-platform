...
if(isset($_POST['name']) && isset($_POST['description']) && isset($_POST['kategori']) && isset($_POST['score']) && isset($_POST['flag']) && isset($_POST['level']) && isset($_GET['id'])){
	$update = $Database->update_flag(mysql_real_escape_string($_POST['name']),mysql_real_escape_string($_POST['description']),mysql_real_escape_string($_POST['kategori']),mysql_real_escape_string($_POST['score']),mysql_real_escape_string($_POST['flag']),mysql_real_escape_string($_POST['level']),$_GET['id']);
	if($update){
		header("Location: /admin/manage-flag?_=success");
	}else{
							...
							<div class="card-content">
								...
								<div class="row">
									...
									<div class="col-sm-10">
										<div class="form-group label-floating is-empty">
											<label class="control-label"></label>
											<input name="kategori" type="text" class="form-control" placeholder="Deskripsi Flag" required="" value="<?=$edit['kategori'];?>">
											<span class="material-input"></span>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="form-group label-floating is-empty">
									<label class="control-label"></label>
									<input name="level" type="text" class="form-control" placeholder="Easy/Normal/Hard" required="" value="<?=$edit['level'];?>">
									<span class="material-input"></span></div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-sm-10">
										<div class="form-group label-floating is-empty">
											<label class="control-label"></label>
											<input name="score" type="number" class="form-control" placeholder="Point" required="" value="<?=$edit['score'];?>">
											<span class="material-input"></span></div>
										</div>
									</div>
