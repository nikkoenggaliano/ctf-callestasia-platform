...
if(isset($_POST['name']) != "" && isset($_POST['description']) != "" && isset($_POST['tipe']) && isset($_POST['author']) != "" ) {
	$status = $Database->tambahkan_tutor(mysql_real_escape_string($_POST['name']),mysql_real_escape_string($_POST['description']),mysql_real_escape_string($_POST['tipe']),mysql_real_escape_string($_POST['author']));	
	if($status == "sukses"){
		header("Location: manage-tutor?_=success");
	}
}
?>
<!DOCTYPE html>
					...
					<div class="card">
						<form method="post" action="" class="form-horizontal">
							...
							<div class="card-content">
								<div class="row">
									<label class="col-sm-2 label-on-left">Nama Tutor</label>
									<div class="col-sm-10">
								...
								<div class="row">
									...
									<div class="col-sm-10">
										<div class="form-group label-floating is-empty">
											<label class="control-label"></label>
											<input name="tipe" type="text" class="form-control" placeholder="Kategori" required="">
								...
								<div class="row">
									...
									<div class="col-sm-10">
										<div class="form-group label-floating is-empty">
											<label class="control-label"></label>
											<input name="author" type="text" class="form-control" placeholder="format flag (sensitive value)" required="">
											<span class="material-input"></span></div>
										</div>
