				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					...
					<div class="card card-stats">
						...
						<div class="card-content">
							...
							<h3 class="card-title"><?= $Database->count_value_score(); echo $count['total'];?></h3>
								...
								<table class="table">
									...
									<thead>
										...
										<tr>
											...
											<th class="text-right">Nama Soal</th>
									...
									foreach ($Database->info_lastsolved("50") as $key => $data) {
										...
										echo '<tr>
											...
											<td class="text-right">'.$data['nama_soal'].'</td>
