					...
					<div class="col-md-12">
						...
						<div class="card-content">
							...
							<div class="row">
								...
								<!-- <a href="?sort=asc" class="btn btn-rose" role="button">Urutan Bawah</a> -->
								<a href="?sort=desc" class="btn btn-rose" role="button">Urutan Atas</a>
										...
										<table class="table">
											...
											<tbody>
												...
												<?php
													...
													$datarray   = $Database->tampilkan_member_list($_GET['sort']);
													...
													foreach ($datarray as $key => $data) {?>
														...
														<tr>
															...
															<td class="td-actions text-right">
																...
																<a href="delete/<?= $data['id']; ?>/user" class="btn btn-danger" role="button"><i class="material-icons" onclick="return confirm('Yakin Mau Hapus <?= $data['username']; ?>?')">close</i></a>
