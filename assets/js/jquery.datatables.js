...
(function( $, window, document, undefined ) {
	...
	function _fnScrollDraw ( settings )
	{
		...
		_fnApplyToChildren( function(nSizer, i) {
			nSizer.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:auto;">'+headerContent[i]+'</div>';
		...
		{
			_fnApplyToChildren( function(nSizer, i) {
				nSizer.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:auto;">'+footerContent[i]+'</div>';
